...
# It is defined by the kaggle/python Docker image: Kaggle/docker-python
...
train_df = pd.read_csv("/mei/yolov5/input/global-wheat-detection/train.csv")
...
fr = cv2.imread("/mei/yolov5/input/global-wheat-detection/train/b6ab77fd7.jpg")
...
import glob
all_imgs = glob.glob("/mei/yolov5/input/global-wheat-detection/train/*.jpg")
...
print('len(negative_images)',len(negative_images))
